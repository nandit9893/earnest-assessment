...
<head>
  ...
  <title>New Task Assigned - ${title}</title>
  <style>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td align="center" style="padding-top:24px;">
                    <h1 style="margin:0; color:#ffffff; font-size:28px; font-weight:700; letter-spacing:-0.5px;">New Task Assigned 📋</h1>
                  </td>
                </tr>
              </table>
             </td>
            ...
            <td style="padding:32px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background:#fafbfc; border-radius:20px; border:1px solid #eef2f8; overflow:hidden;">
                <tr style="border-bottom:1px solid #eef2f8;">
                  <td style="padding:16px 20px; font-weight:600; color:#1a202c; width:35%; background:#ffffff;">Task ID</td>
                  <td style="padding:16px 20px; color:#4a5568; font-weight:500; background:#ffffff; border-left:1px solid #eef2f8;">
                    ${taskID}
                  </td>
                </tr>
                <tr style="border-bottom:1px solid #eef2f8;">
                  <td style="padding:16px 20px; font-weight:600; color:#1a202c; background:#fafbfc;">Task Name</td>
                  <td style="padding:16px 20px; color:#667eea; font-weight:500; background:#fafbfc; border-left:1px solid #eef2f8;">
                    ${taskName}
                  </td>
                </tr>
                <tr style="border-bottom:1px solid #eef2f8;">
                  <td style="padding:16px 20px; font-weight:600; color:#1a202c; background:#fafbfc;">Start Date</td>
                  <td style="padding:16px 20px; color:#667eea; font-weight:500; background:#fafbfc; border-left:1px solid #eef2f8;">
                    ${new Date(startDate).toLocaleDateString()}
                  </td>
                </tr>
                <tr style="border-bottom:1px solid #eef2f8;">
                  <td style="padding:16px 20px; font-weight:600; color:#1a202c; background:#ffffff;">Completion Date</td>
                  <td style="padding:16px 20px; color:#667eea; font-weight:500; background:#ffffff; border-left:1px solid #eef2f8;">
            ...
            <td style="padding:24px 32px 32px 32px; background:#ffffff;">
              <div style="text-align:center; border-top:1px solid #eef2f8; padding-top:24px;">
                ...
                <p style="margin:0; font-size:11px; color:#cbd5e1;">
                  This email was sent to ${supportEmail} regarding your task assignment.
                </p>
