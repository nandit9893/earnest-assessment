...
<a href="${link.link}" target="_blank" rel="noopener noreferrer"
   ...
   ">
   <img src="${iconUrl}" alt="${link.name}" width="20" height="20" style="vertical-align:middle;">
</a>
`;
    })
    .join("");
...
<title>Verify Your Email - ${title}</title>
<style>
...
Please use the verification code below to complete your sign-in process for ${title}.
</p>
</div>
</td>
</tr>
...
<tr style="border-bottom:1px solid #eef2f8;">
<td style="padding:16px 20px; font-weight:600; color:#1a202c; background:#ffffff;">OTP Code</td>
<td style="padding:16px 20px; background:#ffffff; border-left:1px solid #eef2f8;">
<code style="background:#f7fafc; padding:6px 12px; border-radius:8px; font-size:13px; font-weight:600; color:#2d3748; border:1px solid #e2e8f0;">${otpCode}</code>
</td>
</tr>

<tr>
<td style="padding:16px 20px; font-weight:600; color:#1a202c; background:#fafbfc;">Expires In</td>
<td style="padding:16px 20px; background:#fafbfc; border-left:1px solid #eef2f8;">
<span style="background:linear-gradient(135deg, #667eea20 0%, #764ba220 100%); padding:4px 12px; border-radius:20px; font-size:13px; font-weight:600; color:#5a67d8;">${expiryMinutes} Minutes</span>
</td>
</tr>
</table>
</td>
...
<tr>
<td align="center">
<a href="${websiteUrl}" style="background:linear-gradient(135deg, #667eea 0%, #764ba2 100%); color:#ffffff; padding:14px 32px; text-decoration:none; border-radius:50px; font-size:15px; font-weight:600; display:inline-flex; align-items:center; gap:10px; box-shadow:0 8px 20px -8px rgba(102,126,234,0.4);">
Go to Dashboard
</a>
</td>
</tr>
...
This email was sent to ${supportEmail} as part of your email verification process.
</p>
